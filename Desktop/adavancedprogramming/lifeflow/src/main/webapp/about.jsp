...
<%--
    ...
    Author: Pritam Rai
    Module: About Page
    Description: Organisation info, mission, services, and call-to-action.
...
<section class="stats-strip" aria-label="Organisation statistics">
    <div class="stat-item">
        <div class="num">12,400+</div>
        <div class="lbl">Units Donated</div>
    </div>
    <div class="stat-item">
    ...
    <div class="section-wrapper">
        <div class="about-grid">
            <div class="about-text">
                ...
                <p>
                    LifeFlow Blood Bank is a <span class="highlight">non-profit healthcare organisation</span>
                    based in Kathmandu, dedicated to maintaining a safe and adequate supply of blood for patients
                    across the city's hospitals and clinics.
                </p>
                <p>
                    Founded in 2005, we work closely with the Ministry of Health and private healthcare providers to ensure
                    that blood of all types is available when and where it is needed most. Our team of trained
                    medical professionals and volunteers operate 24 hours a day, 7 days a week.
                </p>
                <p>
                    We believe that <span class="highlight">every donation matters</span>. A single blood
                    donation can save up to three lives, and our mission is to make the donation process as
                    simple, safe, and accessible as possible for everyone in the community.
                </p>
            </div>
        ...
        <div class="services-grid">
            <article class="service-item">
                ...
                <div>
                    ...
                    <p>Regular donation drives at our centre and mobile units across Kathmandu. Walk-in and appointment-based sessions available.</p>
                </div>
            </article>
            <article class="service-item">
                <div class="svc-icon">&#128203;</div>
                <div>
                    ...
                    <p>Fast-track processing of blood requests from hospitals and patients. Emergency requests handled within 30 minutes.</p>
                </div>
            </article>
            <article class="service-item">
                <div class="svc-icon">&#128300;</div>
                <div>
                    <h3>Blood Screening &amp; Testing</h3>
                    <p>All donations are tested for infectious diseases and blood type compatibility before being added to our stock.</p>
                </div>
            </article>
            <article class="service-item">
                <div class="svc-icon">&#128666;</div>
                <div>
                    ...
                    <p>24/7 emergency blood supply service for critical care units, trauma centres, and surgical teams across Kathmandu.</p>
                </div>
            </article>
            <article class="service-item">
                <div class="svc-icon">&#128218;</div>
                <div>
                    <h3>Donor Education</h3>
                    <p>Workshops, leaflets, and online resources to educate the public about the importance and process of blood donation.</p>
                </div>
            </article>
            <article class="service-item">
                <div class="svc-icon">&#128202;</div>
                <div>
                    ...
                    <p>Real-time blood stock monitoring and reporting for partner hospitals, ensuring transparency and preparedness.</p>
                </div>
            </article>
        </div>
    </div>
    ...
    <div class="section-wrapper">
        ...
        <div class="awareness-list">
            <div class="awareness-item">
                ...
                <p><strong>One donation saves up to 3 lives.</strong> Your single donation can be separated into red cells, platelets, and plasma.</p>
            </div>
            <div class="awareness-item">
                <span class="check">&#10003;</span>
                <p><strong>Donation takes only 45-60 minutes.</strong> The actual blood draw takes around 10 minutes. The rest is registration and recovery.</p>
            </div>
            <div class="awareness-item">
                <span class="check">&#10003;</span>
                <p><strong>O- is the universal donor type.</strong> It can be given to any patient in an emergency, making it the most critical blood type to stock.</p>
            </div>
            <div class="awareness-item">
                <span class="check">&#10003;</span>
                <p><strong>You can donate every 12 weeks.</strong> Healthy adults aged 17-66 can donate whole blood up to four times per year.</p>
            </div>
            <div class="awareness-item">
                <span class="check">&#10003;</span>
                <p><strong>Blood cannot be manufactured.</strong> There is no artificial substitute for human blood, making donors irreplaceable.</p>
            </div>
            <div class="awareness-item">
                <span class="check">&#10003;</span>
                <p><strong>Demand never stops.</strong> Every day, hospitals in Nepal use around 5,000 units of blood for patients in need.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="cta-section" aria-labelledby="ctaHeading">
    ...
    <div class="cta-buttons">
        <a href="requestBlood.jsp" class="cta-btn-primary" aria-label="Request blood">Request Blood</a>
        <a href="contact.jsp" class="cta-btn-outline" aria-label="Contact us">Contact Us</a>
    </div>
</section>
